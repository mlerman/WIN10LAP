...
//$root_path = $_SERVER['DOCUMENT_ROOT']."/doc/files/Engineering/ENVIRONMENT/PHP_SERVER/tiny_php_file_manager";
//ml root is files but path is in p
$root_path = $_SERVER['DOCUMENT_ROOT']."/doc/files";
