...
var arr_c_cpp = // each line: ['string value to be copied with newlines', 'string to be shown'],
    ...
    ['#include <stdio.h> &#10;  &#10;void reverse(char* begin, char* end) &#10;{ &#10;    char temp; &#10;    while (begin < end) { &#10;        temp = *begin; &#10;        *begin++ = *end; &#10;        *end-- = temp; &#10;    } &#10;} &#10;  &#10;void reverseWords(char* s) &#10;{ &#10;    char* word_begin = NULL; &#10;    char* word_end = s; &#10;  &#10;    while (*word_end) { &#10;        if ((word_begin == NULL) && (*word_end != &apos; &apos;)) { &#10;            word_begin = word_end; &#10;        } &#10;        if (word_begin && ((*(word_end + 1) == &apos; &apos;) || (*(word_end + 1) == 0))) { &#10;            reverse(word_begin, word_end); // reverse each word in place&#10;            word_begin = NULL; &#10;        } &#10;        word_end++; &#10;    } &#10;    // we get here eno owt eerht ruof evif&#10;    reverse(s, word_end - 1); // reverse all s&#10;}&#10;  &#10;int main() &#10;{ &#10;    char str[] = "one two three four five"; &#10;    reverseWords(str); &#10;    printf("%s", str); &#10;    return 0; &#10;} ', 'reverse words | <mark>full</mark>'], 
    ...
    ['int isprime(int n)&#10;{&#10;    int i, flag = 0;&#10;&#10;    if (n<2) return 0;&#10;    for(i=2; i<=n/2; ++i)&#10;    {&#10;        // condition for nonprime number&#10;        if(n%i==0)&#10;        {&#10;            flag=1;&#10;            break;&#10;        }&#10;    }&#10;&#10;    return !flag;&#10;}', 'isprime(int n) | <span style="background-color:cyan">function</span>'],
    ['int isperfect(int n) {&#10;  int i=1;&#10;  int sum = 0;&#10;&#10;  while(i<n){&#10;    if(n%i==0) sum=sum+i;&#10;    i++;&#10;  }&#10;&#10;  if(sum==n) return 1; // ex 6, 28&#10;  return 0;&#10;}&#10;', 'isperfect(int n) | <span style="background-color:cyan">function</span>'], 
    ['int isarmstrong(int n) {&#10;  int num,r,sum=0,temp;&#10;&#10;  temp=n;&#10;  while(n!=0){&#10;    r=n%10;&#10;    n=n/10;&#10;    sum=sum+(r*r*r);&#10;  }&#10;&#10;  if(sum==temp) return 1; // ex 371 &#10;  return 0;&#10;}&#10;', 'isarmstrong(int n) | <span style="background-color:cyan">function</span>'], 
    ['int isstrong(int n) {&#10;  int num,i,f,r,sum=0,temp;&#10;&#10;  temp=n;&#10;  while(n){&#10;    i=1,f=1;&#10;    r=n%10;&#10;&#10;    while(i<=r){&#10;      f=f*i;&#10;      i++;&#10;    }&#10;    sum=sum+f;&#10;      n=n/10;&#10;  }&#10;  if(sum==temp) return 1; // ex 145&#10;  return 0;&#10;}&#10;', 'isstrong(int n) | <span style="background-color:cyan">function</span>'], 
    ['int ispalindrome(int n) {&#10;  int num,r,sum=0,temp;&#10;&#10;  temp=n;&#10;  while(n){&#10;    r=n%10;&#10;    n=n/10;&#10;    sum=sum*10+r;&#10;  }&#10;    &#10;  if(sum==temp) return 1; // ex 16461&#10;  return 0;&#10;}&#10;', 'ispalindrome(int n) | <span style="background-color:cyan">function</span>'], 
    ...
    ['#include <stdio.h>&#10;#include <stdlib.h>&#10;&#10;struct node {&#10;  int data;&#10;  struct node *next;&#10;}*start, *elem1, *elem2, *elem3;&#10;&#10;void scan(struct node *start)&#10;{&#10;  struct node *temp, *last ;&#10;&#10;  temp = start;&#10;  do {&#10;      printf("data : %d next : %p\\n", temp->data, temp->next); &#10;      last = temp;&#10;      temp = temp->next;&#10;  } while(last->next);&#10;}&#10;&#10;void detect_loop(struct node *start)&#10;{&#10;  struct node *ptr1, *ptr2, *last1, *last2 ;&#10;  &#10;  ptr1 = start;&#10;  ptr2 = start;&#10;  &#10;  do {&#10;      printf("ptr1 : %d | ptr2 : %d\\n", ptr1->data, ptr2->data); &#10;      last1 = ptr1;&#10;      ptr1 = ptr1->next;&#10;	  &#10;	  last2 = ptr2;&#10;	  if (ptr2->next) ptr2 = ptr2->next; else break;&#10;	  if (ptr2->next) ptr2 = ptr2->next; else break;&#10;	  &#10;	  if (ptr1 == ptr2) {&#10;        printf("loop detected ");&#10;		break;&#10;	  }&#10;  } while(last1->next);&#10;}&#10;&#10;int main()&#10;{&#10;  elem1 = (struct node*) malloc(sizeof(struct node));&#10;  elem1->data = 1;&#10;&#10;  start = elem1;&#10;&#10;  elem2 = (struct node*) malloc(sizeof(struct node));&#10;  elem2->data = 2;&#10;  elem1->next=elem2;&#10;&#10;  elem3 = (struct node*) malloc(sizeof(struct node));&#10;  elem3->data = 3;&#10;  elem2->next=elem3;&#10;&#10;  //elem3->next=NULL;&#10;  elem3->next=elem1;&#10;  &#10;  //scan(start);&#10;  detect_loop(start);&#10; &#10;  return 0;&#10;}&#10;', 'linked list with loop_detect | <mark>full</mark>'], 
    ['#include <stdio.h>&#10;#include <stdlib.h>&#10;&#10;  struct node {&#10;   int data;&#10;   struct node *next;&#10;   struct node *prev;&#10;  }*start, *elem1, *elem2, *elem3;&#10;&#10;&#10;void deleteNode(struct node **head_ref, struct node *del) &#10;{ &#10;  if(*head_ref == NULL || del == NULL) &#10;    return; &#10;  &#10;  if(*head_ref == del) &#10;    *head_ref = del->next; &#10;  &#10;  if(del->next != NULL) &#10;    del->next->prev = del->prev; &#10;  &#10;  if(del->prev != NULL) &#10;    del->prev->next = del->next;      &#10;  &#10;  free(del); &#10;  return; &#10;}  &#10;&#10;void scan(struct node *node)&#10;{&#10;  while(node!=NULL) &#10;  { &#10;   printf("%d ", node->data); &#10;   node = node->next; &#10;  }&#10;  printf("\\n");&#10;    &#10;}&#10;&#10;int main()&#10;{&#10;&#10;  struct node *temp, *last ;&#10;&#10;  elem1 = (struct node*) malloc(sizeof(struct node));&#10;  elem1->data = 1;&#10;&#10;  start = elem1;&#10;&#10;  elem2 = (struct node*) malloc(sizeof(struct node));&#10;  elem2->data = 2;&#10;  elem1->next=elem2;&#10;  elem2->prev=elem1;&#10;&#10;  elem3 = (struct node*) malloc(sizeof(struct node));&#10;  elem3->data = 3;&#10;  elem2->next=elem3;&#10;  elem3->prev=elem2;&#10;&#10;  elem3->next=NULL;&#10;  elem1->prev=NULL;&#10;  &#10;  scan(start); &#10;  deleteNode(&start, start);&#10;  scan(start); &#10;  deleteNode(&start, start->next);&#10;  scan(start); &#10;  deleteNode(&start, start->next);&#10;  scan(start); &#10;&#10; &#10;  return 0;&#10;}&#10;', 'doubly linked list with scan | <mark>full</mark>'], 
