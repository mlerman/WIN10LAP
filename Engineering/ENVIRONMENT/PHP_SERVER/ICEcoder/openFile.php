<?php
include("lib/headers_no_die.php");
...
<div id="editor" class="editor">
	...
	<div id="findBar" class="findBar" onContextMenu="return false">
		...
		<form onSubmit="return ICEcoder.goToLine()">
			...
			<div class="goLine"><?php echo $t['Go to Line'];?> <input type="text" name="goToLine" value="" id="goToLineNo" class="textbox goToLine"></div>
...
//ml: 
<?php
if($target!="") echo 'top.ICEcoder.openFile("'.$target.'");';
?>
</script>
