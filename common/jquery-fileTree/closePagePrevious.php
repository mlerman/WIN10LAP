...
$link_with="<a href='/doc/files/common/download".$linuxstr."file.php?fname=".$commanderstr."&targetdir=C:".$parent_dir."&urldir=".$link_with_dir_url."&perma=C:\UniServer\www\common\perma".$linuxstr."'><img src='/doc/images/".$commanderpng."' /></a>&nbsp;".'<a href="/doc/files'.$_GET['linkwith'].'" target="'.$with_name.'">'.$with_name.'</a>'.$icon_with."<br/>\n";
