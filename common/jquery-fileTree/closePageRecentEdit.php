...
$link="/doc/files/common/downloadfile.php?fname=".$fname."&targetdir=".$targetdir."&targetfile=".$targetfile."&perma=C:/UniServer/www/doc/files/common/perma&drive=".$_GET['drive'].":"."&param1=".$_GET['param1'];
